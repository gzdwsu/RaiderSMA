...
public class Model {
    ...
    private static int currentMatchID = 0;//this will store the current match id. by making this a global variable this will hopefully remove an unnecessary task from the user
   ...
   public static void saveTournament(){
    ...
    //public static void setCurrentMatch(int match) {
    	//currentMatch = match;
    //}
    ...
    public static void updateMatch(String winningColor, int greenPoints, int redPoints, int fallType, String fallTime){ 
        ...
        advanceTournament();//added a call to advance tournament. this should be done automaticaly for every match updated 
    }
    ...
    public static String getMatchInfo() {
    	String out = "";
    	out += matchBank.get(currentMatchID - 1).greenWrestler;
    	out += " VS ";
    	out += matchBank.get(currentMatchID - 1).redWrestler;
    	out += ", Round: ";
    	out += matchBank.get(currentMatchID - 1).roundNumber;
    	return out;
    }
